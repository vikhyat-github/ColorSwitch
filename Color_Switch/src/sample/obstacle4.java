...
public class obstacle4 extends obstacle{
    ...
    Paint color[]={Color.RED,Color.PURPLE};
...
//        Shape[] shapes = new Shape[8];
    ...
    public obstacle4(AnchorPane anchorPane,Paint ballColor,double speed)  {
...
//        anchorPane.getChildren().addAll(star.getPolygon1(),star.getPolygon2());
        ...
        animateAnti(circle1arc1,speed);
        animateAnti(circle1arc2,speed);
        animateAnti(circle1arc3,speed);
        animateAnti(circle1arc4,speed);
        ...
        animate(circle3arc1,speed);
        animate(circle3arc2,speed);
        animate(circle3arc3,speed);
        animate(circle3arc4,speed);
